        ...
        <div className="create-quiz-container">
            <div className="model">
                <div className="first-model" style={{ display: model ? 'flex' : 'none' }}>
                    <input type="text" name="quizName" placeholder="Quiz name" id="quizName" autoComplete="off" autoFocus value={quiz.quizName || errors.quizNameError} onChange={handleInputChange} style={{ border: errors.quizNameError ? '1px solid red' : '' }} />
                    <div>
                        <div className="quiz-type">
                            <span className="type">Quiz type</span>
                            <span className={quiz.quizType === 'Q&A' ? 'q activeType' : 'q'} onClick={() => handleType('Q&A')} style={{ border: errors.quizTypeError ? '1px solid red' : '' }}>
                                Q & A
                            </span>
                            <span className={quiz.quizType === 'Poll' ? 'q activeType' : 'q'} onClick={() => handleType('Poll')} style={{ border: errors.quizTypeError ? '1px solid red' : '' }}>
                                Poll
                            </span>
                        </div>
                    </div>
                ...
                <div className="buttons">
                    ...
                    <button className="continue" onClick={handleContinue} style={{ display: model ? 'block' : 'none' }}>
                        Continue
                    </button>
                    <button className='continue' style={{ display: model ? 'none' : 'block' }} onClick={handleCreateQuiz}>
                        Create Quiz
                    </button>
                </div>
            </div>
